...
<body>
	...
	<div class="middle">
		...
		<div class="login-title">registration employee</div>

		<div>

			<form action="EmployeeRegistration" method="post" autocomplete="off">
				<div class="container">
					<div class="col-md-6">
					...
					<div class="col-md-12">
						<button type="submit"
							onclick="document.getElementById('employeePopup').style.display='block'"
							class="PopupLogin">Register Employee</button>
					</div>
		...
		<div id="employeePopup" class="modal employee">
